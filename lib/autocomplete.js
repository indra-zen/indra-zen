// Autocomplete module
// Menyediakan util untuk suggestion command & path.
// TODO: akan ditingkatkan nested path, grep khusus, multi kolom.
...
// Factory untuk integrasi penuh di UI
// Params: { inputEl, mirrorEl, writeLine, COMMANDS, getCwd, fsApi:{getNode,isDir} }
export function createAutocomplete({ inputEl, mirrorEl, writeLine, COMMANDS, getCwd, fsApi }) {
  ...
  function updateMirror() {
    mirrorEl.innerHTML = renderUserInput(inputEl.value);
  }
